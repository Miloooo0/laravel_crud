<nav class="block w-full max-w-full px-4 py-2 mx-auto bg-white shadow-md rounded-md lg:px-8 lg:py-3 mt-10">
    ...
    <div class="hidden lg:block">
      <ul class="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        <li class="flex items-center p-1 text-sm gap-x-2 text-slate-600">
          ...
          <a href="/alumnos" class="flex items-center">
            Tabla
          </a>
        </li>
        <li class="flex items-center p-1 text-sm gap-x-2 text-slate-600">
        ...
        <li class="flex items-center p-1 text-sm gap-x-2 text-slate-600">
          ...
          <a href="https://miloooo0.github.io/portfolio" class="flex items-center">
            Documentación
          </a>
        </li>
      ...
      @if(Auth::check())
        <p class="flex items-center p-1 text-sm gap-x-2 text-slate-600">Hola {{ Auth::user()->name }}</p>
